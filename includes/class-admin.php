...
class LimoSMS_Admin {
    ...
    private $pattern_management_tab;
    ...
    public function __construct() {
        ...
        $this->pattern_management_tab = new LimoSMS_Pattern_Management_Tab();
        ...
        if ( method_exists( $this->pattern_management_tab, 'register_hooks' ) ) {
            $this->pattern_management_tab->register_hooks();
        }
