        ...
        <form class="limosms-mobile-auth__form" method="post" action="">
            <div class="limosms-mobile-auth__step limosms-mobile-auth__step--mobile is-active" data-step="mobile">
                <div class="limosms-mobile-auth__field">
                    <label for="limosms_mobile"><?php esc_html_e( 'شماره موبایل', 'limosms' ); ?></label>
                    <input
                        type="tel"
                        id="limosms_mobile"
                        name="mobile"
                ...
                <button type="button" class="limosms-mobile-auth__button limosms-mobile-auth__button--primary" id="limosms-send-code">
                    <?php esc_html_e( 'دریافت کد', 'limosms' ); ?>
                </button>
            </div>

            <div class="limosms-mobile-auth__step limosms-mobile-auth__step--code" data-step="code" hidden>
                <div class="limosms-mobile-auth__field">
                    <label for="limosms_code"><?php esc_html_e( 'کد تایید', 'limosms' ); ?></label>
                    <input
                        type="text"
                        id="limosms_code"
                        name="code"
                        class="limosms-mobile-auth__input"
                        placeholder="<?php esc_attr_e( 'کد تایید', 'limosms' ); ?>"
                        inputmode="numeric"
                ...
                <div class="limosms-mobile-auth__actions">
                    <button type="button" class="limosms-mobile-auth__button limosms-mobile-auth__button--secondary" id="limosms-edit-mobile">
                        <?php esc_html_e( 'ویرایش شماره', 'limosms' ); ?>
                    </button>

                    <button type="button" class="limosms-mobile-auth__button limosms-mobile-auth__button--primary" id="limosms-verify-code">
                        <?php esc_html_e( 'تایید', 'limosms' ); ?>
                    </button>
                </div>
            </div>
